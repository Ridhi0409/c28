...
var backgroundMusicSound,piratesSound,cannonExplosionSound,cannonWaterSound;
...
function preload() {
  ...
  piratesSound = loadSound("aasets/pirate_laugh.mp3");
...
function draw() {
  ...
  if(!backgroundMusicSound.isPlaying()){
    ...
    backgroundMusicSound.seVolume(0.1);
  }
